...
namespace GameV10.GameStates.InGame.Levels
{
    internal class GameEasy : TestGame
    {
        public GameEasy(Game1 game1, GraphicsDeviceManager graphicsDeviceManager, ContentManager content, GraphicsDevice graphicsDevice, string gamertag) : base(game1, graphicsDeviceManager, content, graphicsDevice)
        {
            GamerTag = gamertag;
            ...
            Game1.BasicEnemys.Add(new(playertextureNorth, playertextureSouth, playertextureWest, playertextureNorthWest, playertextureSouthWest, new Vector2(500, 500), new Vector2(0, 0), new Vector2(64, 128), 1, 1000, HeuristicFormula.Manhattan, healthBar, healthBar));
