...
namespace GameV10.GameStates.Menus
{
    ...
    internal class GameOver : State
    {
        ...
        public GameOver(Game1 game1, GraphicsDeviceManager graphicsDeviceManager, ContentManager content, GraphicsDevice graphicsDevice, Texture2D backgroundTextureMM, string PlayerName, int PlayerScore, float PlayerStime, int PlayerKills) : base(game1, graphicsDeviceManager, content, graphicsDevice)
        {
            PName = PlayerName;
            PScore = PlayerScore;
            PStime = PlayerStime;
